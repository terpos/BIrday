...
enum {ROCKET_LAZER_AMMO, STUNNER_AMMO, BOMB_AMMO, ICE_BOMB_AMMO, FIRE_BOMB_AMMO, ATOMIC_BOMB_AMMO, BI_NUKE_AMMO, TRI_NUKE_AMMO, 
...
enum {MENU_SCREEN, GAME_SCREEN, GAME_MATERIAL_SCREEN, OPTION_SCREEN, QUIT_SCREEN, PAUSE_SCREEN, GAME_OVER_SCREEN};
